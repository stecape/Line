...
export default class PIDCalculating extends Component {
  constructor(props){
    super(props)
  ...
  render() {
    ...
    var ID = "PIDCalculating" + Math.trunc(Math.random()*1000) + Math.trunc(Math.random()*1000)
