...
export default class WTCAxisSpeedCalculating extends Component {
  constructor(props){
    super(props)
  ...
  render() {
    ...
    var ID = "WTCAxisSpeedCalculating" + Math.trunc(Math.random()*1000) + Math.trunc(Math.random()*1000)
      ...
      <g>
        <defs>
          <g id={ID}>
            ...
            <text x="14" y="12" style={text}>reMachineSpeedIN * reNormalizedCircumferenceMinTP</text>
...
WTCAxisSpeedCalculating.defaultProps = {
  x: 0,
  y: 0,
  green: false,
  textPosOffsetX: 0,
...
WTCAxisSpeedCalculating.propTypes = {
  x: PropTypes.number,
  y: PropTypes.number,
