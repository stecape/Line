...
export default class WTCAxisSpeedRampGradientCalculating extends Component {
  constructor(props){
    super(props)
  ...
  render() {
    ...
    var ID = "WTCAxisSpeedRampGradientCalculating" + Math.trunc(Math.random()*1000) + Math.trunc(Math.random()*1000)
      ...
      <g>
        <defs>
          <g id={ID}>
            ...
            <text x="8" y="12" style={text}>reMachineSpeedMaxIN * reNormalizedCircumferenceMinTP</text>
            <text x="68" y="27" style={text}>reCircumferenceTP</text>
          </g>
        </defs>
...
WTCAxisSpeedRampGradientCalculating.defaultProps = {
  x: 0,
  y: 0,
  green: false,
  textPosOffsetX: 0,
...
WTCAxisSpeedRampGradientCalculating.propTypes = {
  x: PropTypes.number,
  y: PropTypes.number,
