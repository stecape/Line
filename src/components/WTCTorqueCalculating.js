...
export default class WTCTorqueCalculating extends Component {
  constructor(props){
    super(props)
  ...
  render() {
    ...
    var ID = "WTCTorqueCalculating" + Math.trunc(Math.random()*1000) + Math.trunc(Math.random()*1000)
      ...
      <g>
        <defs>
          <g id={ID}>
            ...
            <line x1="4" y1="18" x2="136" y2="18" />
            <text x="6" y="12" style={text}>reTensionTP * reRadiusTP * reFrictionsIN</text>
...
WTCTorqueCalculating.defaultProps = {
  x: 0,
  y: 0,
  green: false,
  textPosOffsetX: 0,
...
WTCTorqueCalculating.propTypes = {
  x: PropTypes.number,
  y: PropTypes.number,
