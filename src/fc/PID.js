    ...
    return (
      <div>
        ...
        <svg viewBox="0 0 960 540" >
          ...
          />
          <Line x1="134" y1="102" x2="154" y2="102" green={true} />
          <Line x1="154" y1="132" x2="154" y2="102" green={true} />
          ...
          <Inversion
            ...
            green={!bool(this.state.bo_PIDEnable_IN)}
          />
          <Line x1="134" y1="132" x2="154" y2="132" green={!true} />
          ...
          {/*                                                                                    Ramo Derivativa */}
          <Line x1="270" y1="132" x2="270" y2="62" green={true} />
          <Line x1="270" y1="62" x2="290" y2="62" green={true} />
          <Multiply
            x={290}
            y={56}
            green={bool(this.state.bo_PIDEnable_IN)}
          ...
          />
          <Line x1="280" y1="36" x2="296" y2="36" green={true} />
          <Line x1="296" y1="36" x2="296" y2="56" green={true} />
          <Line x1="302" y1="62" x2="322" y2="62" green={true} />
          <Derivative
            x={322}
            y={56}
            green={bool(this.state.bo_PIDEnable_IN)}
          />
          <Line x1="334" y1="62" x2="418" y2="62" green={true} />
          <SwitchNO
            x={418}
            y={56}
            green={bool(this.state.bo_DerivativeEnable_IN) & bool(this.state.bo_PIDEnable_IN)}
            textPosOffsetX={0}
            textPosOffsetY={0}
            varName="bo_DerivativeEnable_IN"
            varValue={bool(this.state.bo_DerivativeEnable_IN)}
          />
          <Line x1="430" y1="62" x2="450" y2="62" green={bool(this.state.bo_DerivativeEnable_IN) & bool(this.state.bo_PIDEnable_IN)} />
          <TestPoint
            x={450}
            y={56}
            green={bool(this.state.bo_DerivativeEnable_IN) & bool(this.state.bo_PIDEnable_IN)}
          ...
          />
          <Line x1="462" y1="62" x2="482" y2="62" green={bool(this.state.bo_DerivativeEnable_IN) & bool(this.state.bo_PIDEnable_IN)} />
          <Line x1="482" y1="62" x2="482" y2="126" green={bool(this.state.bo_DerivativeEnable_IN) & bool(this.state.bo_PIDEnable_IN)} />
          ...
          {/*                                                                                 Ramo Integrativa */}
          <Line x1="270" y1="132" x2="270" y2="202" green={true} />
          <Line x1="270" y1="202" x2="290" y2="202" green={true} />
          <Divide
            x={290}
            y={196}
            green={bool(this.state.bo_PIDEnable_IN)}
          ...
          />
          <Line x1="280" y1="176" x2="296" y2="176" green={true} />
          <Line x1="296" y1="176" x2="296" y2="196" green={true} />
          <Line x1="302" y1="202" x2="322" y2="202" green={true} />
          <Switch
            x={322}
            y={199}
            green={bool(this.state.bo_PIDEnable_IN)}
          ...
          />
          <Line x1="334" y1="205" x2="354" y2="205" green={true} />
          <Sum
            x={354}
            y={199}
            green={bool(this.state.bo_PIDEnable_IN)}
          />
                  ...
                  />
                  <Line x1="24" y1="282" x2="70" y2="282" green={!true} />
                  <InternalReference
                    x={0}
                    y={318}
                    green={!true}
                  ...
                  />
                  <Line x1="24" y1="322" x2="76" y2="322" green={!true} />
                  <Line x1="76" y1="322" x2="76" y2="288" green={!true} />
                  <Difference
                    x={70}
                    y={276}
                    green={!bool(this.state.bo_PIDEnable_IN)}
                    ...
                    signPosOffsetY={0}
                  />
                  <Line x1="82" y1="282" x2="290" y2="282" green={!true} />
                  <Divide
                    x={290}
                    y={276}
                    green={!bool(this.state.bo_PIDEnable_IN)}
                  ...
                  />        
                  <Line x1="280" y1="256" x2="296" y2="256" green={!true} />
                  <Line x1="296" y1="256" x2="296" y2="276" green={!true} />
                  <Line x1="302" y1="282" x2="312" y2="282" green={!true} />
                  <Line x1="312" y1="282" x2="312" y2="208" green={!true} />
                  <Line x1="312" y1="208" x2="322" y2="208" green={!true} />
                  {/*                                                                         Fine sezione - Ingresso Ramo Manuale */}

                  {/*                                                                                Inizio sezione - Anti Wind Up */}
                  <Line x1="572" y1="132" x2="572" y2="226" green={bool(this.state.bo_PIDEnable_IN)} />
                  <Line x1="578" y1="232" x2="618" y2="232" green={bool(this.state.bo_PIDEnable_IN)} />
                  <Difference
                    x={566}
                    y={226}
                    green={bool(this.state.bo_PIDEnable_IN)}
                  ...
                  <Sum
                    ...
                    green={bool(this.state.bo_PIDEnable_IN)}
                  />
                  <Line x1="624" y1="226" x2="624" y2="132" green={bool(this.state.bo_PIDEnable_IN)} />
                  <Line x1="740" y1="132" x2="740" y2="226" green={bool(this.state.bo_PIDEnable_IN)} />
                  <Difference
                    x={734}
                    y={226}
                    green={bool(this.state.bo_PIDEnable_IN)}
                    ...
                    signPosOffsetY={-20}
                  />
                  <Line x1="734" y1="232" x2="630" y2="232" green={bool(this.state.bo_PIDEnable_IN)} />
                  <Line x1="792" y1="132" x2="792" y2="232" green={bool(this.state.bo_PIDEnable_IN)} />
                  <Line x1="792" y1="232" x2="746" y2="232" green={bool(this.state.bo_PIDEnable_IN)} />
                  <Line x1="572" y1="238" x2="572" y2="282" green={bool(this.state.bo_PIDEnable_IN)} />
                  <Line x1="572" y1="282" x2="360" y2="282" green={bool(this.state.bo_PIDEnable_IN)} />
                  <Line x1="360" y1="282" x2="360" y2="211" green={bool(this.state.bo_PIDEnable_IN)} />
                  {/*                                                                                  Fine sezione - Anti Wind Up */}

          <Line x1="366" y1="205" x2="386" y2="205" green={true} />
          <Integrative
            x={386}
            y={199}
            green={bool(this.state.bo_PIDEnable_IN)}
          ...
          <Line x1="398" y1="205" x2="418" y2="205" green={true} />
          <SwitchNO
            x={418}
            y={199}
            green={bool(this.state.bo_PIDEnable_IN)}
          ...
          />
          <Line x1="430" y1="205" x2="450" y2="205" green={true} />
          <TestPoint
            x={450}
            y={199}
            green={bool(this.state.bo_PIDEnable_IN)}
          ...
          />
          <Line x1="462" y1="205" x2="482" y2="205" green={true} />
          <Line x1="482" y1="205" x2="482" y2="138" green={true} />
          ...
          <Sum
            ...
            green={bool(this.state.bo_PIDEnable_IN)}
          />
          <Line x1="682" y1="126" x2="682" y2="68" green={bool(this.state.bo_PIDEnable_IN)} />
          <SwitchNO
            x={676}
            y={56}
          ...
          />
          <Line x1="666" y1="36" x2="682" y2="36" green={true} />
          <Line x1="682" y1="36" x2="682" y2="56" green={true} />

          <Line x1="688" y1="132" x2="708" y2="132" green={true} />   
          <TestPoint
            x={708}
            y={126}
            green={bool(this.state.bo_PIDEnable_IN)}
          ...
          />
          <Line x1="720" y1="132" x2="760" y2="132" green={true} />          
          <Limitator
            x={760}
            y={126}
            green={bool(this.state.bo_PIDEnable_IN)}
          ...
          <Output
            ...
            x={786}
            y={96}
            green={bool(this.state.bo_PIDEnable_IN) & bool(this.state.bo_OutWindUp_OUT)}
            textPosOffsetX={0}
            textPosOffsetY={0}
            varName="bo_OutWindDown_OUT"
            varValue={bool(this.state.bo_OutWindUp_OUT)}
          />
          <Line x1="750" y1="100" x2="766" y2="100" green={bool(this.state.bo_PIDEnable_IN)} />
          <Line x1="766" y1="100" x2="786" y2="100" green={bool(this.state.bo_PIDEnable_IN) & bool(this.state.bo_OutWindUp_OUT)} />
          <Line x1="766" y1="100" x2="766" y2="126" green={bool(this.state.bo_PIDEnable_IN)} />
          <Input
            x={726}
            y={164}
            green={bool(this.state.bo_PIDEnable_IN)}
          ...
          <Output
            ...
            x={786}
            y={164}
            green={bool(this.state.bo_PIDEnable_IN) & bool(this.state.bo_OutWindDown_OUT)}
            textPosOffsetX={0}
            textPosOffsetY={34}
            varName="bo_OutWindDown_OUT"
            varValue={bool(this.state.bo_OutWindDown_OUT)}
          />
          <Line x1="750" y1="168" x2="766" y2="168" green={bool(this.state.bo_PIDEnable_IN)} />
          <Line x1="766" y1="168" x2="786" y2="168" green={bool(this.state.bo_PIDEnable_IN) & bool(this.state.bo_OutWindDown_OUT)} />
          <Line x1="766" y1="138" x2="766" y2="168" green={bool(this.state.bo_PIDEnable_IN)} />
          <Line x1="772" y1="132" x2="812" y2="132" green={true} />
          <TestPoint
            x={812}
            y={126}
            green={bool(this.state.bo_PIDEnable_IN)}
            ...
            varValue={this.state.re_OutValue_TP}
          />
          <Line x1="824" y1="132" x2="844" y2="132" green={bool(this.state.bo_PIDEnable_IN)} />
          <Output
            x={844}
            y={128}
            green={true}
